...
@register_solver('dream_edit')
class DreamEdit(EditWardSwapDDIM):
    '''
    Real image editing based on DeramSampler
    '''
    ...
    def reverse_process(self,
        ...
        src_img = kwargs.get('src_img', None)
        assert src_img is not None, "src_img must be provided to DreamEdit.sample()."
